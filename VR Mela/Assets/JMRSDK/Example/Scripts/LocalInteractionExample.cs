...
public class LocalInteractionExample : MonoBehaviour, ISelectHandler, ISelectClickHandler, IFn1Handler, IFn2Handler, IBackHandler, IFocusable, IVoiceHandler, IManipulationHandler, ITouchHandler
{
    public Text _text;
